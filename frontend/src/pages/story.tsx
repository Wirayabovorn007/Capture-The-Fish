          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="relative">
              ...
              <div className="relative z-10 max-w-[900px]">
                ...
                >
                  <p>
                    ในการทดสอบระบบ มีการค้นพบข้อมูลเก่าที่ไม่ควรยังคงอยู่บนเซิร์ฟเวอร์
                    และไม่มีใครรู้ว่าข้อมูลเหล่านั้นถูกทิ้งไว้ตั้งแต่เมื่อใด
                  </p>

                  <p className="mt-1">
                    สถานีวิจัยแห่งหนึ่งกำลังตรวจสอบระบบติดตามการอพยพของปลาแซลมอน
                    หลังจากพบความผิดปกติบางอย่างในระบบ
                  </p>

                  <p className="mt-1">
                    ทีมวิจัยเชื่อว่ามีบางอย่างถูกซ่อนไว้
                    แต่ไม่มีใครสามารถระบุได้ว่ามันอยู่ที่ไหน
                  </p>

                  <p className="mt-1">
                    คุณได้รับหน้าที่ให้สำรวจเว็บไซต์
                    และค้นหาสิ่งที่นักวิจัยคนก่อนทิ้งเอาไว้
                  </p>

                  <p className="mt-1">
                    ทุกเบาะแสอาจนำไปสู่ความจริงที่อยู่ลึกลงไปกว่าเดิม
                  </p>
                </div>
              </div>
            </div>
